...
export const MenuList: MenuItem[] = [
  {
    ...
    Items: [
      ...
      },
      {
        ...
        id: 1,
        title: "MT5 Account",
        path: `${process.env.PUBLIC_URL}/mt5account`,
        type: "link",
      },
      {
        icon: "Shield",
      ...
      },
      {
        ...
        path: `${process.env.PUBLIC_URL}/packagehistory`,
        type: "link",
      },
      {
        icon: "Star",
        ...
        children: [
          ...
          { path: `${process.env.PUBLIC_URL}/rankandreward`, title: "Rank & Reward", type: "link" },
      ...
      },
      {
        ...
        title: "Payout Income",
        children: [
          { path: `${process.env.PUBLIC_URL}/monthlyprofitincome`, title: "Trading Profit", type: "link" },
          { path: `${process.env.PUBLIC_URL}/botlevelincome`, title: "Bot Generation", type: "link" },
          { path: `${process.env.PUBLIC_URL}/botmatchingincome`, title: "Bot Matching", type: "link" },
          { path: `${process.env.PUBLIC_URL}/profitsharing`, title: "Profit Sharing", type: "link" },
          { path: `${process.env.PUBLIC_URL}/clubincome`, title: "Club Income", type: "link" },
          { path: `${process.env.PUBLIC_URL}/ibincome`, title: "IB Income", type: "link" },
          { path: `${process.env.PUBLIC_URL}/fasttrackincome`, title: "Fast Track Income", type: "link" },
      ...
      },
      {
        ...
        children: [
          ...
          { path: `${process.env.PUBLIC_URL}/tree`, title: "Network Tree", type: "link" },
          { path: `${process.env.PUBLIC_URL}/binarytree`, title: "Genealogy", type: "link" },
      ...
      },
      {
        ...
        id: 1,
        title: "Business Plan",
        path: `http://122.160.25.202/PrimeorbitAI/memberpanel/PrimeOrbitAi_Final.pdf`,
        type: "link",
