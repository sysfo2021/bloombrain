...
export const LifeTimeReward: TableColumn<any>[] = [
  ...
  },
  {
    ...
    selector: (row: any) => row["AchievementDate"],
    sortable: true,
    center: false,
    width: "200px",
    cell: (row) => (
      <div dangerouslySetInnerHTML={{ __html: row.AchievementDate }} />
    ),
  },
  {
    name: "PaidStatus",
...
export const getSponsorList = (
  handlePlacement: (clientId: string) => void
): TableColumn<SponsorListInterface>[] => [
  {
    name: "SNo",
  ...
  {
    name: "JoiningAmount",
    selector: (row) => row.JoiningAmount,
    sortable: true,
  },
  {
    name: "Status",
  ...
  },
  {
    ...
    cell: (row) =>
      row.Placement === "Yes" ? (
        <button
          className="mr-2 mb-2 btn btn-xs btn-success btn-margin"
          onClick={() => handlePlacement(row.ClientId)}
        >
          PLACE MEMBER
        </button>
      ) : null,
...
export const PackageInvestmentColumn: any[] = [
  {
    name: "SNo",
    selector: (row: any) => row["SNo"],
    sortable: true,
...
export const BotMatchingReportColumn: any[] = [
  {
    name: "S.No.",
    selector: (row: any) => row["S.No."],
    sortable: true,
  ...
  {
    name: "Left Opening Balance",
    selector: (row: any) => row["LeftOpeningBalance"],
    sortable: true,
    center: true,
    width: "250px",
  },
  {
    name: "Right Opening Balance",
    selector: (row: any) => row["RightOpeningBalance"],
    sortable: true,
    center: true,
    width: "250px",
  },
  {
    name: "Left Current Business",
    selector: (row: any) => row["LeftCurrentBusiness"],
    sortable: true,
    center: true,
    width: "250px",
  },
  {
    name: "Right Current Business",
    selector: (row: any) => row["RightCurrentBusiness"],
    sortable: true,
    center: true,
    width: "250px",
  },
  {
    name: "Left Business",
    selector: (row: any) => row["LeftBusiness"],
    sortable: true,
    center: true,
    width: "250px",
  },
  {
    name: "Right Business",
    selector: (row: any) => row["RightBusiness"],
    sortable: true,
    center: true,
    width: "250px",
  },
  {
    name: "Left Remaining Business",
    selector: (row: any) => row["LeftRemainingBusiness"],
    sortable: true,
    center: true,
    width: "250px",
  },
  ...
  {
    name: "Right Remaining Business",
    selector: (row: any) => row["RightRemainingBusiness"],
    sortable: true,
    center: true,
    width: "250px",
  },
  {
    name: "Matching Business",
    selector: (row: any) => row["MatchingBusiness"],
    sortable: true,
    center: true,
    width: "250px",
  },
  {
    name: "Per Pair Rate",
    selector: (row: any) => row["PerPairRate"],
    sortable: true,
    center: true,
    width: "250px",
  },
...
export const FastTrackReportColumn: any[] = [
  {
    name: "S.No.",
    selector: (row: any) => row["S.No."],
    sortable: true,
