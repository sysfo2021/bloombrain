  ...
  return (
    ...
    <Col xl="6" sm="12">
      <Row>
        <Col xl="6" sm="12">
          ...
          <Card className="project-card">
            <CardBody className="pt-0 px-2">
              <H4>
                <button style={{ padding: '5px' }} className="edge-btn f-13 f-10 w-100 btn btn-light-primary mt-2">Last Login {props?.LastLogin}</button>
              </H4>
        ...
        <Col xl="6" sm="12">
          <div>
            {myWallets.map((itm:any, idx:number)=> <Btn key={idx} color="primary f-14 mb-3 text-black w-100 height74 btnBg text-right">
              <Row>
                <div className="col-4 col-md-4 col-sm-4">
                  <center>
                    <Image className="b-r-10 img-50" src={dynamicImage(`avatar/1.png`)} style={{ filter: 'invert(1)',  }} alt="avatar" />
                  </center>
                </div>
                <div className="col-8 order-first col-md-8 col-sm-8" style={{ textAlign: 'left' }}>
