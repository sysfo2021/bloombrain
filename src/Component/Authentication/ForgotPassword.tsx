    ...
    <Container fluid className="p-0 video-container">
      ...
      <Row className="m-0">
        <Col xs="12" className="p-0">
          <div className="login-card login-dark" style={{ backgroundColor: "transparent !important" }}>
            <div>
                ...
                >
                  {({ isSubmitting }) => (
                    <Form className="theme-form">
                      ...
                      <P className="text-center">{"Please enter your Member ID, and we will send a password reset link to the mobile number and email registered with us."}</P>
