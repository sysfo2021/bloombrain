...
import { PayoutTitle, BotMatchingIncome } from "../../../utils/Constant";
...
import { serverColumn, BotMatchingReportColumn } from '../../../Data/TableData/TableData';
...
//   const [Formvalue, setFormValue] = useState({})
 ...
 useMemo(()=>{
  ...
  setAPIPayload({
    ...
    Para:JSON.stringify({ClientId:memberID,FromDate:formattedFromDate, ToDate:formattedToDate, ActionMode:"BotMatchingIncome"})
  })
 },[])
 ...
 const handleSubmit = (values: FormValues) => {
  ...
  return (
    <>
      <Breadcrumbs mainTitle={BotMatchingIncome} parent={PayoutTitle} ChildName={BotMatchingIncome}/>
      <Container fluid>
      <Formik
    ...
    >
      {({ setFieldValue, values, errors, touched }) => (
        <Form>
          ...
          <HistoryTable ColumnData={BotMatchingReportColumn} SeaarchData_date={SeaarchData_date} apiPayload={API_Payload}/>
      </Container>
    </>
  );
};

export default Botmatchingincome;
