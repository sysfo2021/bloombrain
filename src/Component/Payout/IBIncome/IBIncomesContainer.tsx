...
import { PayoutTitle, IBIncomeReport } from "../../../utils/Constant";
...
//   const [Formvalue, setFormValue] = useState({})
 ...
 const handleSubmit = (values: FormValues) => {
  ...
  return (
    <>
      <Breadcrumbs mainTitle={IBIncomeReport} parent={PayoutTitle} ChildName={IBIncomeReport}/>
      <Container fluid>
      <Formik
...
export default IBIncomesContainer;
