...
export default class BinaryTree extends React.Component {
  ...
  render() {
    ...
    return (
      <Container>
        <Row>
        <Col id="binary-tree" className="Treant " style={{ height: "auto", overflowX:'scroll', scrollbarWidth:'thin' }}>
        {/* {
          (selectedUserLevel,
          ...
          {(disableNavigation, bgButton, colorButton && <>
            <div className="navigation-buttons" style={{display: disableNavigation ? 'none' : 'flex' }}>
              <div>
                <Btn
                  type="button"
                  color={this.state.selectedUser === this.props.rootUser ? '' : "primary"}
              ...
              <div className="buttons-bottom">
                <Btn
                     color={!this.state.selectedUser.left_child_id ? '' : "primary"}
                ...
                <Btn
                  ...
                  color={!this.state.selectedUser.right_child_id ? '' : "primary"}
