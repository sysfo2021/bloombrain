...
import { PackageHistory, DepositHistoryTitle } from "../../utils/Constant";
import Breadcrumbs from "../../CommonElements/Breadcrumbs/Breadcrumbs";
import HistoryTable from "../../CommonElements/SearchTable/SearchTable"
import { PackageInvestmentColumn } from '../../Data/TableData/TableData';
...
twoDaysAgo.setDate(twoDaysAgo.getDate() - 10);
   ...
   useMemo(()=>{
    ...
    setAPIPayload({
      ...
      Para:JSON.stringify({ClientId:memberID,FromDate:formattedFromDate, ToDate:formattedToDate, ActionMode:"TokenPurchaseHistory"})
    })
   },[])
  ...
  return (
    <>
    <Breadcrumbs mainTitle={PackageHistory} parent={PackageHistory} />
      <Container fluid>
      <Col xl="12">
          <Formik
    ...
    <SearchTable ColumnData={PackageInvestmentColumn} SeaarchData_date={SeaarchData_date}  apiPayload={API_Payload}/>  
          </Col>
      </Container>
    </>
  );
