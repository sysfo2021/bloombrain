            ...
            <Row>
                <Col className="col-md-4">
                    <div className="w-100 card">
                        <div className="pb-0 card-no-border  card-header">
                            <H4> Stronger Zone Business</H4>
                        </div>
                        <div className="card-body">
                            <P className="me-55 ">
                            ${TeamData[0]?.StrongerZoneBusiness}
                            </P> 
                        </div>
                    </div>
                </Col>
                <Col className="col-md-4">
                    <div className="w-100 card">
                    <div className="pb-0 card-no-border  card-header">
                            <H4> Other Zone Business</H4>
                        </div>
                        <div className="card-body">
                            <P className="me-55"> ${TeamData[0]?.WeakerZoneBusiness}</P> 
                        </div>
                    </div>
                </Col>
            </Row>
